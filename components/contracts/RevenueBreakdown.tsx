...
export function RevenueBreakdown({
  ...
  // Generate random colors for services
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(revenueData.totalRevenue * (revenuePercentage / 100))}</div>
            <p className="text-xs text-muted-foreground mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(revenueData.totalRevenue * ((100 - revenuePercentage) / 100))}</div>
            <p className="text-xs text-muted-foreground mt-1">
        ...
        <CardContent>
          {revenueData.serviceBreakdown.length === 0 ? (
            ...
            <div className="space-y-4">
              {revenueData.serviceBreakdown.map((service, index) => (
